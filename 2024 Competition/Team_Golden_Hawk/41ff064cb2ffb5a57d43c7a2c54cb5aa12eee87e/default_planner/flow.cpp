...
//remove flow for each location's outgoing edge according to the traj and decrement soc
...
/**
 * @brief add flow for each location's outgoing edge according to the traj and update replan time and soc for total solution
 */
...
/**
 * @brief replan agent via aStar algorithm accoring to deviation in descending order
 */
...
//update traj and reset distance table for agent i
