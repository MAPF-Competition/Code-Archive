...
#ifndef STATETIMEASTAR_H
#define STATETIMEASTAR_H
...
public:
    ...
    void findTrajectory(const BasicGraph& G,
                        ...
                        const boost::unordered_map<int, double>& travel_times,
...
private:
    ...
    boost::unordered_set< StateTimeAStarNode*, StateTimeAStarNode::Hasher, StateTimeAStarNode::EqNode> allNodes_table;
