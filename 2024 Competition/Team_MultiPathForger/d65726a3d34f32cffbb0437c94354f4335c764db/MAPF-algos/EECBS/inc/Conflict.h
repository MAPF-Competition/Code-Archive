...
typedef std::tuple<int, int, int, int, constraint_type> EECBS_PREFIX_Constraint;
...
std::ostream& operator<<(std::ostream& os, const EECBS_PREFIX_Constraint& constraint);


class EECBS_PREFIX_Conflict
{
public:
	int a1;
	int a2;
	...
	bool rectangleConflict(int a1, int a2, const std::pair<int, int>& Rs, const std::pair<int, int>& Rg,
	                         int Rg_t, const list<EECBS_PREFIX_Constraint>& constraint1, const list<EECBS_PREFIX_Constraint>& constraint2) // For RM
	{
		this->a1 = a1;
		this->a2 = a2;
...
std::ostream& operator<<(std::ostream& os, const EECBS_PREFIX_Conflict& conflict);

bool operator < (const EECBS_PREFIX_Conflict& conflict1, const EECBS_PREFIX_Conflict& conflict2);
