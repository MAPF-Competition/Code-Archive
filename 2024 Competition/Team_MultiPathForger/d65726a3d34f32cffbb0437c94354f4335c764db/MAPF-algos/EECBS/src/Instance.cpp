...
EECBS_PREFIX_Instance::EECBS_PREFIX_Instance(const string& map_fname, const string& agent_fname, 
...
int EECBS_PREFIX_Instance::randomWalk(int curr, int steps) const
{
...
void EECBS_PREFIX_Instance::generateRandomAgents(int warehouse_width)
{
...
bool EECBS_PREFIX_Instance::validMove(int curr, int next) const
{
...
bool EECBS_PREFIX_Instance::addObstacle(int obstacle)
{
	if (my_map[obstacle])
		return false;
...
bool EECBS_PREFIX_Instance::isConnected(int start, int goal)
{
	std::queue<int> open;
...
void EECBS_PREFIX_Instance::generateConnectedRandomGrid(int rows, int cols, int obstacles)
{
	...
	/*moves_offset[EECBS_PREFIX_Instance::valid_moves_t::WAIT_MOVE] = 0;
	moves_offset[EECBS_PREFIX_Instance::valid_moves_t::NORTH] = -num_of_cols;
	moves_offset[EECBS_PREFIX_Instance::valid_moves_t::EAST] = 1;
	moves_offset[EECBS_PREFIX_Instance::valid_moves_t::SOUTH] = num_of_cols;
	moves_offset[EECBS_PREFIX_Instance::valid_moves_t::WEST] = -1;*/
...
bool EECBS_PREFIX_Instance::loadMap()
{
...
void EECBS_PREFIX_Instance::printMap() const
{
	for (int i = 0; i< num_of_rows; i++)
	{
		for (int j = 0; j < num_of_cols; j++)
...
void EECBS_PREFIX_Instance::saveMap() const
{
	ofstream myfile;
...
bool EECBS_PREFIX_Instance::loadAgents()
{
	using namespace std;
	using namespace boost;
...
void EECBS_PREFIX_Instance::printAgents() const
{
  for (int i = 0; i < num_of_agents; i++) 
  {
...
void EECBS_PREFIX_Instance::saveAgents() const
{
  ofstream myfile;
...
list<int> EECBS_PREFIX_Instance::getNeighbors(int curr) const
{
	list<int> neighbors;
