...
private:
    ...
    int m_replan = 0; // number of agents to replan at each step
    std::chrono::high_resolution_clock::time_point m_start_time;
    int m_time_limit = 1; // Allowed time for planning
    ...
    std::vector<double> m_alpha_v;
    std::vector<double> m_beta_v;
    std::vector<int> m_enqueue_bound_v;
};
