...
void MAPFPlanner::initialize(int preprocess_time_limit)
{
    ...
    // build_row_highway(endtime);
    // build_column_highway(endtime);
...
void MAPFPlanner::build_partition_highway(TimePoint _endtime)
{
    ...
    //*
    int num_highway_row = 4; // 有多少个highway行
    ...
    for(int i=0;i<num_highway_row;i++)
    {
        ...
        for(int j=0; j < highway_row.trajs[i].size() - 1; j++)
        {
            ...
            forbids[highway_row.trajs[i][j]].emplace_back(get_d(diff, env));
        }
        // cout << endl;
    ...
    //*
    int num_highway_column = 4; // 有多少个highway列
...
// lifelong.exe --inputFile ../../../example_problems/random.domain/random_32_32_20_100.json -o test.json -s 3000 -t 1000
// lifelong.exe --inputFile ../../../example_problems/city.domain/paris_1_256_250.json -o test.json -s 3000 -t 1000
// lifelong.exe --inputFile ../../../example_problems/game.domain/brc202d_500.json -o test.json -s 3000 -t 1000
// lifelong.exe --inputFile ../../../example_problems/warehouse.domain/sortation_large_2000.json -o test.json -s 3000 -t 1000
// lifelong.exe --inputFile ../../../example_problems/warehouse.domain/warehouse_large_5000.json -o test.json -s 3000 -t 1000
