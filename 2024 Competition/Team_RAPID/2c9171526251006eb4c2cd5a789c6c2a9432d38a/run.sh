...
./build/lifelong --inputFile example_problems/random.domain/random_32_32_20_800.json $ARGS -o ${OUTPUT_FOLDER}test_random_800_${VERSION}.json --simulationTime 5000 
...
# ./build/lifelong --inputFile example_problems/game.domain/brc202d_500.json $ARGS -o ${OUTPUT_FOLDER}test_game_${VERSION}.json --simulationTime 2000
