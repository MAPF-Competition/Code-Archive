...
class RoutingSearchParameters_LocalSearchNeighborhoodOperators final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:operations_research.RoutingSearchParameters.LocalSearchNeighborhoodOperators) */ {
 public:
  ...
  explicit PROTOBUF_CONSTEXPR RoutingSearchParameters_LocalSearchNeighborhoodOperators(
      ::google::protobuf::internal::ConstantInitialized);

  inline RoutingSearchParameters_LocalSearchNeighborhoodOperators(const RoutingSearchParameters_LocalSearchNeighborhoodOperators& from) : RoutingSearchParameters_LocalSearchNeighborhoodOperators(nullptr, from) {}
  inline RoutingSearchParameters_LocalSearchNeighborhoodOperators(RoutingSearchParameters_LocalSearchNeighborhoodOperators&& from) noexcept
      : RoutingSearchParameters_LocalSearchNeighborhoodOperators(nullptr, std::move(from)) {}
  ...
  friend void swap(RoutingSearchParameters_LocalSearchNeighborhoodOperators& a, RoutingSearchParameters_LocalSearchNeighborhoodOperators& b) { a.Swap(&b); }
  ...
  RoutingSearchParameters_LocalSearchNeighborhoodOperators* New(::google::protobuf::Arena* arena = nullptr) const final {
    return ::google::protobuf::Message::DefaultConstruct<RoutingSearchParameters_LocalSearchNeighborhoodOperators>(arena);
  }
  using ::google::protobuf::Message::CopyFrom;
  void CopyFrom(const RoutingSearchParameters_LocalSearchNeighborhoodOperators& from);
  using ::google::protobuf::Message::MergeFrom;
  void MergeFrom(const RoutingSearchParameters_LocalSearchNeighborhoodOperators& from) { RoutingSearchParameters_LocalSearchNeighborhoodOperators::MergeImpl(*this, from); }
 ...
 private:
  ...
  static ::absl::string_view FullMessageName() { return "operations_research.RoutingSearchParameters.LocalSearchNeighborhoodOperators"; }
 ...
 protected:
  ...
  RoutingSearchParameters_LocalSearchNeighborhoodOperators(::google::protobuf::Arena* arena, RoutingSearchParameters_LocalSearchNeighborhoodOperators&& from) noexcept
...
class RoutingSearchParameters_ImprovementSearchLimitParameters final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:operations_research.RoutingSearchParameters.ImprovementSearchLimitParameters) */ {
 public:
  ...
  template <typename = void>
  explicit PROTOBUF_CONSTEXPR RoutingSearchParameters_ImprovementSearchLimitParameters(
      ::google::protobuf::internal::ConstantInitialized);

  inline RoutingSearchParameters_ImprovementSearchLimitParameters(const RoutingSearchParameters_ImprovementSearchLimitParameters& from) : RoutingSearchParameters_ImprovementSearchLimitParameters(nullptr, from) {}
  inline RoutingSearchParameters_ImprovementSearchLimitParameters(RoutingSearchParameters_ImprovementSearchLimitParameters&& from) noexcept
      : RoutingSearchParameters_ImprovementSearchLimitParameters(nullptr, std::move(from)) {}
  ...
  friend void swap(RoutingSearchParameters_ImprovementSearchLimitParameters& a, RoutingSearchParameters_ImprovementSearchLimitParameters& b) { a.Swap(&b); }
  ...
  RoutingSearchParameters_ImprovementSearchLimitParameters* New(::google::protobuf::Arena* arena = nullptr) const final {
    return ::google::protobuf::Message::DefaultConstruct<RoutingSearchParameters_ImprovementSearchLimitParameters>(arena);
  }
  using ::google::protobuf::Message::CopyFrom;
  void CopyFrom(const RoutingSearchParameters_ImprovementSearchLimitParameters& from);
  using ::google::protobuf::Message::MergeFrom;
  void MergeFrom(const RoutingSearchParameters_ImprovementSearchLimitParameters& from) { RoutingSearchParameters_ImprovementSearchLimitParameters::MergeImpl(*this, from); }
 ...
 private:
  friend class ::google::protobuf::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() { return "operations_research.RoutingSearchParameters.ImprovementSearchLimitParameters"; }
 ...
 protected:
  ...
  RoutingSearchParameters_ImprovementSearchLimitParameters(::google::protobuf::Arena* arena, RoutingSearchParameters_ImprovementSearchLimitParameters&& from) noexcept
...
class RoutingModelParameters final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:operations_research.RoutingModelParameters) */ {
 public:
  inline RoutingModelParameters() : RoutingModelParameters(nullptr) {}
  ~RoutingModelParameters() override;
  template <typename = void>
  explicit PROTOBUF_CONSTEXPR RoutingModelParameters(
      ::google::protobuf::internal::ConstantInitialized);

  inline RoutingModelParameters(const RoutingModelParameters& from) : RoutingModelParameters(nullptr, from) {}
  inline RoutingModelParameters(RoutingModelParameters&& from) noexcept
      : RoutingModelParameters(nullptr, std::move(from)) {}
  ...
  friend void swap(RoutingModelParameters& a, RoutingModelParameters& b) { a.Swap(&b); }
  ...
  RoutingModelParameters* New(::google::protobuf::Arena* arena = nullptr) const final {
    return ::google::protobuf::Message::DefaultConstruct<RoutingModelParameters>(arena);
  }
  using ::google::protobuf::Message::CopyFrom;
  void CopyFrom(const RoutingModelParameters& from);
  using ::google::protobuf::Message::MergeFrom;
  void MergeFrom(const RoutingModelParameters& from) { RoutingModelParameters::MergeImpl(*this, from); }
 ...
 private:
  friend class ::google::protobuf::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() { return "operations_research.RoutingModelParameters"; }
 ...
 protected:
  ...
  RoutingModelParameters(::google::protobuf::Arena* arena, RoutingModelParameters&& from) noexcept
      : RoutingModelParameters(arena) {
    *this = ::std::move(from);
  }
  const ::google::protobuf::MessageLite::ClassData* GetClassData()
      const final;
...
class RoutingSearchParameters final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:operations_research.RoutingSearchParameters) */ {
 public:
  inline RoutingSearchParameters() : RoutingSearchParameters(nullptr) {}
  ~RoutingSearchParameters() override;
  template <typename = void>
  explicit PROTOBUF_CONSTEXPR RoutingSearchParameters(
      ::google::protobuf::internal::ConstantInitialized);

  inline RoutingSearchParameters(const RoutingSearchParameters& from) : RoutingSearchParameters(nullptr, from) {}
  inline RoutingSearchParameters(RoutingSearchParameters&& from) noexcept
      : RoutingSearchParameters(nullptr, std::move(from)) {}
  ...
  friend void swap(RoutingSearchParameters& a, RoutingSearchParameters& b) { a.Swap(&b); }
  ...
  RoutingSearchParameters* New(::google::protobuf::Arena* arena = nullptr) const final {
    return ::google::protobuf::Message::DefaultConstruct<RoutingSearchParameters>(arena);
  }
  using ::google::protobuf::Message::CopyFrom;
  void CopyFrom(const RoutingSearchParameters& from);
  using ::google::protobuf::Message::MergeFrom;
  void MergeFrom(const RoutingSearchParameters& from) { RoutingSearchParameters::MergeImpl(*this, from); }
 ...
 private:
  friend class ::google::protobuf::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() { return "operations_research.RoutingSearchParameters"; }
 ...
 protected:
  ...
  RoutingSearchParameters(::google::protobuf::Arena* arena, RoutingSearchParameters&& from) noexcept
      : RoutingSearchParameters(arena) {
    *this = ::std::move(from);
  }
  const ::google::protobuf::MessageLite::ClassData* GetClassData()
      const final;
 ...
 public:
  ...
  enum : int {
    ...
    kIteratedLocalSearchParametersFieldNumber = 60,
    ...
    kUseIteratedLocalSearchFieldNumber = 58,
    ...
    kFirstSolutionOptimizationPeriodFieldNumber = 59,
  };
  // string log_tag = 36;
  void clear_log_tag() ;
  ...
  PROTOBUF_NODISCARD ::operations_research::IteratedLocalSearchParameters* release_iterated_local_search_parameters();
  ::operations_research::IteratedLocalSearchParameters* mutable_iterated_local_search_parameters();
  void set_allocated_iterated_local_search_parameters(::operations_research::IteratedLocalSearchParameters* value);
  void unsafe_arena_set_allocated_iterated_local_search_parameters(::operations_research::IteratedLocalSearchParameters* value);
  ::operations_research::IteratedLocalSearchParameters* unsafe_arena_release_iterated_local_search_parameters();

  private:
  const ::operations_research::IteratedLocalSearchParameters& _internal_iterated_local_search_parameters() const;
  ::operations_research::IteratedLocalSearchParameters* _internal_mutable_iterated_local_search_parameters();
  ...
  private:
  bool _internal_use_iterated_local_search() const;
  void _internal_set_use_iterated_local_search(bool value);
  ...
  private:
  ::int32_t _internal_first_solution_optimization_period() const;
  void _internal_set_first_solution_optimization_period(::int32_t value);
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::operations_research::IteratedLocalSearchParameters* iterated_local_search_parameters_;
    ...
    bool log_search_;
    bool use_iterated_local_search_;
    ...
    ::int32_t first_solution_optimization_period_;
    PROTOBUF_TSAN_DECLARE_MEMBER
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_ortools_2fconstraint_5fsolver_2frouting_5fparameters_2eproto;
...
// int32 first_solution_optimization_period = 59;
inline void RoutingSearchParameters::clear_first_solution_optimization_period() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_.first_solution_optimization_period_ = 0;
}
inline ::int32_t RoutingSearchParameters::first_solution_optimization_period() const {
  // @@protoc_insertion_point(field_get:operations_research.RoutingSearchParameters.first_solution_optimization_period)
  return _internal_first_solution_optimization_period();
}
inline void RoutingSearchParameters::set_first_solution_optimization_period(::int32_t value) {
  _internal_set_first_solution_optimization_period(value);
  // @@protoc_insertion_point(field_set:operations_research.RoutingSearchParameters.first_solution_optimization_period)
}
inline ::int32_t RoutingSearchParameters::_internal_first_solution_optimization_period() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return _impl_.first_solution_optimization_period_;
}
inline void RoutingSearchParameters::_internal_set_first_solution_optimization_period(::int32_t value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_.first_solution_optimization_period_ = value;
}
...
inline ::operations_research::RoutingSearchParameters_LocalSearchNeighborhoodOperators* RoutingSearchParameters::_internal_mutable_local_search_operators() {
  ...
  if (_impl_.local_search_operators_ == nullptr) {
    auto* p = ::google::protobuf::Message::DefaultConstruct<::operations_research::RoutingSearchParameters_LocalSearchNeighborhoodOperators>(GetArena());
...
inline ::operations_research::RoutingSearchParameters_ImprovementSearchLimitParameters* RoutingSearchParameters::_internal_mutable_improvement_limit_parameters() {
  ...
  if (_impl_.improvement_limit_parameters_ == nullptr) {
    auto* p = ::google::protobuf::Message::DefaultConstruct<::operations_research::RoutingSearchParameters_ImprovementSearchLimitParameters>(GetArena());
...
// bool use_iterated_local_search = 58;
inline void RoutingSearchParameters::clear_use_iterated_local_search() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_.use_iterated_local_search_ = false;
}
inline bool RoutingSearchParameters::use_iterated_local_search() const {
  // @@protoc_insertion_point(field_get:operations_research.RoutingSearchParameters.use_iterated_local_search)
  return _internal_use_iterated_local_search();
}
inline void RoutingSearchParameters::set_use_iterated_local_search(bool value) {
  _internal_set_use_iterated_local_search(value);
  // @@protoc_insertion_point(field_set:operations_research.RoutingSearchParameters.use_iterated_local_search)
}
inline bool RoutingSearchParameters::_internal_use_iterated_local_search() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return _impl_.use_iterated_local_search_;
}
inline void RoutingSearchParameters::_internal_set_use_iterated_local_search(bool value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_.use_iterated_local_search_ = value;
}

// .operations_research.IteratedLocalSearchParameters iterated_local_search_parameters = 60;
inline bool RoutingSearchParameters::has_iterated_local_search_parameters() const {
  bool value = (_impl_._has_bits_[0] & 0x00000020u) != 0;
  PROTOBUF_ASSUME(!value || _impl_.iterated_local_search_parameters_ != nullptr);
  return value;
}
inline const ::operations_research::IteratedLocalSearchParameters& RoutingSearchParameters::_internal_iterated_local_search_parameters() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  const ::operations_research::IteratedLocalSearchParameters* p = _impl_.iterated_local_search_parameters_;
  return p != nullptr ? *p : reinterpret_cast<const ::operations_research::IteratedLocalSearchParameters&>(::operations_research::_IteratedLocalSearchParameters_default_instance_);
}
inline const ::operations_research::IteratedLocalSearchParameters& RoutingSearchParameters::iterated_local_search_parameters() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:operations_research.RoutingSearchParameters.iterated_local_search_parameters)
  return _internal_iterated_local_search_parameters();
}
inline void RoutingSearchParameters::unsafe_arena_set_allocated_iterated_local_search_parameters(::operations_research::IteratedLocalSearchParameters* value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (GetArena() == nullptr) {
    delete reinterpret_cast<::google::protobuf::MessageLite*>(_impl_.iterated_local_search_parameters_);
  }
  _impl_.iterated_local_search_parameters_ = reinterpret_cast<::operations_research::IteratedLocalSearchParameters*>(value);
  if (value != nullptr) {
...
inline ::operations_research::IteratedLocalSearchParameters* RoutingSearchParameters::release_iterated_local_search_parameters() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);

  _impl_._has_bits_[0] &= ~0x00000020u;
  ::operations_research::IteratedLocalSearchParameters* released = _impl_.iterated_local_search_parameters_;
  _impl_.iterated_local_search_parameters_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old = reinterpret_cast<::google::protobuf::MessageLite*>(released);
  released = ::google::protobuf::internal::DuplicateIfNonNull(released);
  if (GetArena() == nullptr) {
...
inline ::operations_research::IteratedLocalSearchParameters* RoutingSearchParameters::unsafe_arena_release_iterated_local_search_parameters() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  // @@protoc_insertion_point(field_release:operations_research.RoutingSearchParameters.iterated_local_search_parameters)

  _impl_._has_bits_[0] &= ~0x00000020u;
  ::operations_research::IteratedLocalSearchParameters* temp = _impl_.iterated_local_search_parameters_;
  _impl_.iterated_local_search_parameters_ = nullptr;
  return temp;
}
inline ::operations_research::IteratedLocalSearchParameters* RoutingSearchParameters::_internal_mutable_iterated_local_search_parameters() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (_impl_.iterated_local_search_parameters_ == nullptr) {
    auto* p = ::google::protobuf::Message::DefaultConstruct<::operations_research::IteratedLocalSearchParameters>(GetArena());
    _impl_.iterated_local_search_parameters_ = reinterpret_cast<::operations_research::IteratedLocalSearchParameters*>(p);
  }
  return _impl_.iterated_local_search_parameters_;
}
inline ::operations_research::IteratedLocalSearchParameters* RoutingSearchParameters::mutable_iterated_local_search_parameters() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  _impl_._has_bits_[0] |= 0x00000020u;
  ::operations_research::IteratedLocalSearchParameters* _msg = _internal_mutable_iterated_local_search_parameters();
  // @@protoc_insertion_point(field_mutable:operations_research.RoutingSearchParameters.iterated_local_search_parameters)
  return _msg;
}
inline void RoutingSearchParameters::set_allocated_iterated_local_search_parameters(::operations_research::IteratedLocalSearchParameters* value) {
  ::google::protobuf::Arena* message_arena = GetArena();
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (message_arena == nullptr) {
    delete reinterpret_cast<::google::protobuf::MessageLite*>(_impl_.iterated_local_search_parameters_);
...
inline ::operations_research::ConstraintSolverParameters* RoutingModelParameters::_internal_mutable_solver_parameters() {
  ...
  if (_impl_.solver_parameters_ == nullptr) {
    auto* p = ::google::protobuf::Message::DefaultConstruct<::operations_research::ConstraintSolverParameters>(GetArena());
