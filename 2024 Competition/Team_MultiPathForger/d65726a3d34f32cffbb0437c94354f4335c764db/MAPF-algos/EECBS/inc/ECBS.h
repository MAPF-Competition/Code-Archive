...
{
public:
	ECBS(const EECBS_PREFIX_Instance& instance, bool sipp, int screen) : CBS(instance, sipp, screen) {}
...
private:
	...
	vector< pair<EECBS_PREFIX_Path, int> > paths_found_initially;  // contain initial paths found
	...
	void computeConflictPriority(shared_ptr<EECBS_PREFIX_Conflict>& con, ECBSNode& node);
