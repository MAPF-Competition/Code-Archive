...
int main(int argc, char **argv)
{
    ...
    desc.add_options()("help", "produce help message")
        ...
        ("inputFile,i", po::value<std::string>()->default_value("../example_problems/random.domain/random_32_32_20_100.json"), "input file name")
        ("output,o", po::value<std::string>()->default_value("../results/random_32_32_20_100.json"), "output results from the evaluation into a JSON formated file. If no file specified, the default name is 'output.json'")
        // ("inputFile,i", po::value<std::string>()->default_value("../example_problems/game.domain/brc202d_3000.json"), "input file name")
        // ("output,o", po::value<std::string>()->default_value("../results/brc202d_3000.json"), "output results from the evaluation into a JSON formated file. If no file specified, the default name is 'output.json'")
        // ("inputFile,i", po::value<std::string>()->default_value("../example_problems/warehouse.domain/sortation_large_2000.json"), "input file name")
        // ("output,o", po::value<std::string>()->default_value("../results/sortation.json"), "output results from the evaluation into a JSON formated file. If no file specified, the default name is 'output.json'")
        // ("inputFile,i", po::value<std::string>()->default_value("../example_problems/warehouse.domain/warehouse_large_5000.json"), "input file name")
        // ("output,o", po::value<std::string>()->default_value("../results/warehouse.json"), "output results from the evaluation into a JSON formated file. If no file specified, the default name is 'output.json'")
        // ("inputFile,i", po::value<std::string>()->default_value("../example_problems/city.domain/paris_1_256_250.json"), "input file name")
        // ("output,o", po::value<std::string>()->default_value("../results/city.json"), "output results from the evaluation into a JSON formated file. If no file specified, the default name is 'output.json'")
        ...
        ("preprocessTimeLimit,p", po::value<int>()->default_value(1800000), "the time limit for preprocessing in milliseconds")
