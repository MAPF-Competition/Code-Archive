...
int get_path_cost(const LACAM_PREFIX_Solution &solution, int i)
{
...
int get_makespan_lower_bound(const LACAM_PREFIX_Instance &ins, LACAM_PREFIX_DistTable &dist_table)
{
  int c = 0;
...
int get_sum_of_costs_lower_bound(const LACAM_PREFIX_Instance &ins, LACAM_PREFIX_DistTable &dist_table)
{
  int c = 0;
  for (size_t i = 0; i < ins.N; ++i) {
