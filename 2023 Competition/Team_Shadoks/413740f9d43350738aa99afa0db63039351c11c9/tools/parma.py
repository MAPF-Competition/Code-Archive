...
# parma = {
#   'must_have_moved': {0:[], 1:[], 2:[3,4,5]}
#   }

parma = {
  'alpha' : {.1:[.08,.15], .2:[.15,.3], .4:[.3,.5]},
  'beta' : {1.2:[1,1.4], 1.6:[1.4,1.8], 1.9:[1.8,2]},
  'enqueue_bound' : {45:[30,60], 75:[60,90]},
  }

            # param.values["alpha"] = 0.2;
            # param.values["beta"] = 1.6;
            # param.values["enqueue_bound"] = 60;
