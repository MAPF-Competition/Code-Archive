...
public:
    ...
    WarehousePlanner(SharedEnvironment *env) : env(env){};
    virtual ~WarehousePlanner() {
        delete [] mapFree; 
        delete [] freeCells;
        delete [] nebors;
    ...
    void sortAgents(vector<int> &agents_vector);
    void writeMap();
    int W1, W2; //weights of A*
    std::mutex mutex_cellCost;
};