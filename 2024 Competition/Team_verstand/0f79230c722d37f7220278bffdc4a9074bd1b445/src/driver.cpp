...
int main(int argc, char **argv)
{
    ...
    desc.add_options()("help", "produce help message")
        ...
        ("preprocessTimeLimit,p", po::value<int>()->default_value(60000), "the time limit for preprocessing in milliseconds")
    ...
    system_ptr->saveResults(vm["output"].as<std::string>(),vm["outputScreen"].as<int>());
    system_ptr->saveMyResults(vm["output"].as<std::string>(),vm["outputScreen"].as<int>());
...
// --inputFile ../example_problems/random.domain/random_32_32_20_100.json -o test.json
