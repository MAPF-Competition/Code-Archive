...
public:
    ...
    void plan(SharedEnvironment & env, std::vector<Path> * precomputed_paths=nullptr, std::vector<::State> * starts=nullptr, std::vector<::State> * goals=nullptr);
    ...
    Instance build_instance(SharedEnvironment & env, std::vector<Path> * precomputed_paths=nullptr);
