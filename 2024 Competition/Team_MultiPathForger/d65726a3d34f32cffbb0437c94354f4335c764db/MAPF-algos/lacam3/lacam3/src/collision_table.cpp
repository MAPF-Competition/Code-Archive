...
LACAM_PREFIX_CollisionTable::LACAM_PREFIX_CollisionTable(const LACAM_PREFIX_Instance *ins)
    : body(ins->G->size()),
...
LACAM_PREFIX_CollisionTable::~LACAM_PREFIX_CollisionTable() {}

int LACAM_PREFIX_CollisionTable::getCollisionCost(const LACAM_PREFIX_Vertex *v_from, const LACAM_PREFIX_Vertex *v_to,
                                     const int t_from)
{
...
void LACAM_PREFIX_CollisionTable::enrollPath(const int i, LACAM_PREFIX_Path &path)
{
...
void LACAM_PREFIX_CollisionTable::clearPath(const int i, LACAM_PREFIX_Path &path)
{
  if (path.empty()) return;
