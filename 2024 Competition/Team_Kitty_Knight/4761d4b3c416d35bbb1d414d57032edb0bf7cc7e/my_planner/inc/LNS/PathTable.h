...
public:
    ...
    explicit PathTable(int map_size = 0, int window_size=-1) : table(map_size), goals(map_size, MAX_TIMESTEP), window_size(window_size) {}
};
...
public:
    ...
    void clear();
    explicit PathTableWC(int map_size = 0, int num_of_agents = 0) : table(map_size), goals(map_size, MAX_TIMESTEP),
