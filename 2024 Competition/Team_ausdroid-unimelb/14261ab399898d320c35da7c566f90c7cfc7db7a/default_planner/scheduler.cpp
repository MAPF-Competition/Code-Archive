...
void schedule_initialize(int preprocess_time_limit, SharedEnvironment* env)
{
    ...
    // Uncomment the following to allow preprocessing the heuristic map
    // const int heuristic_time_limit = 1800000
    // TimePoint limit = std::chrono::steady_clock::now() + std::chrono::milliseconds(heuristic_time_limit);
...
void schedule_plan(int time_limit, std::vector<int> & proposed_schedule,  SharedEnvironment* env)
{
    ...
    cout << "Default: Assigned Task: " << assigned << "\n";
    #ifndef NDEBUG
