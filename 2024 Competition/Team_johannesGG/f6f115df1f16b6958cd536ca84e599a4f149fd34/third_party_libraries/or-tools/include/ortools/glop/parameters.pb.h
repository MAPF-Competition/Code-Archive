...
class GlopParameters final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:operations_research.glop.GlopParameters) */ {
 public:
  ...
  explicit PROTOBUF_CONSTEXPR GlopParameters(
 ...
 protected:
  ...
  GlopParameters(::google::protobuf::Arena* arena, GlopParameters&& from) noexcept
