...
namespace ParallelLNSSchedulerWeighted
{
    ...
    struct SharedData
    {
        ...
        explicit SharedData(std::unordered_map<unsigned short, std::vector<LNSSchedulerWeighted::TaskCost>> &costs)
    ...
    struct OptimizationData
    {
        ...
        OptimizationData(WeightedCostType obj, const std::unordered_set<int> &ca)
