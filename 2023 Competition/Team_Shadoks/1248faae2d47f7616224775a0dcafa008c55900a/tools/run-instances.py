...
def run_with_parameters(instances, t, steps):
	parameters_list = []
	for enqueue_bound in range(20, 200, 40):
		parameters_list.append({'planner': 'SAT', 'barriers': 0, 'enqueue_bound': enqueue_bound, 'greedy': 1, 'steps': 2, 'time_bound': 0.97, 'shots': 1})
	results = []
