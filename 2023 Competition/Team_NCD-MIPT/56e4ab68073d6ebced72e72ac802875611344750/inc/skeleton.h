...
public:
    ...
    : width_{width}, height_{height}, data_( false, width_ * height_)
    {}
    ...
    {}
    Image(unsigned width, unsigned height, std::vector<int> &data) : width_{ width}, height_{height}, data_(false, width_ * height_)
    {
...
constexpr const Image::pixel_t Image::BLACK_PIX = true;
constexpr const Image::pixel_t Image::WHITE_PIX = false;
