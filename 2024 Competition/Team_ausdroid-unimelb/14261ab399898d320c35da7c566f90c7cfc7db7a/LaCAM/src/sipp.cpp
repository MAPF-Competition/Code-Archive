...
SINode::SINode(const int _uuid, const SI &si, _Vertex *_v, int _t, int _g,
...
_Path sipp(const int i, _Vertex *s_i, _Vertex *g_i, DistTable *D,
          CollisionTable *CT, const Deadline *deadline, const int f_upper_bound)
{
  auto solution_path = _Path();
