...
class DemonRuns final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:operations_research.DemonRuns) */ {
 public:
  inline DemonRuns() : DemonRuns(nullptr) {}
  ~DemonRuns() override;
  template <typename = void>
  explicit PROTOBUF_CONSTEXPR DemonRuns(
      ::google::protobuf::internal::ConstantInitialized);

  inline DemonRuns(const DemonRuns& from) : DemonRuns(nullptr, from) {}
  inline DemonRuns(DemonRuns&& from) noexcept
      : DemonRuns(nullptr, std::move(from)) {}
  ...
  friend void swap(DemonRuns& a, DemonRuns& b) { a.Swap(&b); }
  ...
  DemonRuns* New(::google::protobuf::Arena* arena = nullptr) const final {
    return ::google::protobuf::Message::DefaultConstruct<DemonRuns>(arena);
  }
  using ::google::protobuf::Message::CopyFrom;
  void CopyFrom(const DemonRuns& from);
  using ::google::protobuf::Message::MergeFrom;
  void MergeFrom(const DemonRuns& from) { DemonRuns::MergeImpl(*this, from); }
 ...
 private:
  ...
  static ::absl::string_view FullMessageName() { return "operations_research.DemonRuns"; }

 protected:
  explicit DemonRuns(::google::protobuf::Arena* arena);
  DemonRuns(::google::protobuf::Arena* arena, const DemonRuns& from);
  DemonRuns(::google::protobuf::Arena* arena, DemonRuns&& from) noexcept
      : DemonRuns(arena) {
    *this = ::std::move(from);
  }
...
class ConstraintRuns final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:operations_research.ConstraintRuns) */ {
 public:
  inline ConstraintRuns() : ConstraintRuns(nullptr) {}
  ~ConstraintRuns() override;
  template <typename = void>
  explicit PROTOBUF_CONSTEXPR ConstraintRuns(
      ::google::protobuf::internal::ConstantInitialized);

  inline ConstraintRuns(const ConstraintRuns& from) : ConstraintRuns(nullptr, from) {}
  inline ConstraintRuns(ConstraintRuns&& from) noexcept
      : ConstraintRuns(nullptr, std::move(from)) {}
  ...
  friend void swap(ConstraintRuns& a, ConstraintRuns& b) { a.Swap(&b); }
  ...
  ConstraintRuns* New(::google::protobuf::Arena* arena = nullptr) const final {
    return ::google::protobuf::Message::DefaultConstruct<ConstraintRuns>(arena);
  }
  using ::google::protobuf::Message::CopyFrom;
  void CopyFrom(const ConstraintRuns& from);
  using ::google::protobuf::Message::MergeFrom;
  void MergeFrom(const ConstraintRuns& from) { ConstraintRuns::MergeImpl(*this, from); }
 ...
 private:
  friend class ::google::protobuf::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() { return "operations_research.ConstraintRuns"; }

 protected:
  explicit ConstraintRuns(::google::protobuf::Arena* arena);
  ConstraintRuns(::google::protobuf::Arena* arena, const ConstraintRuns& from);
  ConstraintRuns(::google::protobuf::Arena* arena, ConstraintRuns&& from) noexcept
      : ConstraintRuns(arena) {
    *this = ::std::move(from);
  }
  const ::google::protobuf::MessageLite::ClassData* GetClassData()
      const final;
 ...
 public:
  ...
  ::google::protobuf::RepeatedPtrField<::operations_research::DemonRuns>* mutable_demons();
