...
int main(int argc, char **argv)
{
    ...
    desc.add_options()("help", "produce help message")
        ...
        ("simulationTime,s", po::value<int>()->default_value(1500), "run simulation")
        ...
        ("preprocessTimeLimit,p", po::value<int>()->default_value(INT_MAX), "the time limit for preprocessing in milliseconds")
