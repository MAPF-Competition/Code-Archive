...
int CollisionTable::getCollisionCost(const _Vertex *v_from, const _Vertex *v_to,
                                     const int t_from)
{
...
void CollisionTable::enrollPath(const int i, _Path &path)
{
...
void CollisionTable::clearPath(const int i, _Path &path)
{
  if (path.empty()) return;
