...
int get_makespan_paths(const std::vector<_Path> &solution);

int get_path_cost(const Solution &solution, int i);  // single-agent path cost
int get_path_cost(const _Path &path);
int get_sum_of_costs(const Solution &solution);
int get_sum_of_costs_paths(const std::vector<_Path> &solution);

int get_path_loss(const _Path &path);
int get_sum_of_loss(const Solution &solution);
int get_sum_of_loss(const Solution &solution, std::vector<int> &agents_subset);
int get_sum_of_loss_paths(const std::vector<_Path> &solution);
